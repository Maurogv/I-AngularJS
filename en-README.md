...
As I wanted additional features, with **Javascript** I built the index, the notes, the list of domain names of each external link, a list is for photos only. Text mentions the sources, My text mentions the sources, and the code creates a progressive hypertext number that goes to the associated one, and in the notes goes back up.   
