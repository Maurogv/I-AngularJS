...
Poichè volevo funzionalità aggiuntive, con **Javascript** ho costruito l'indice e le note. Il testo cita le fonti, quindi esso aggiunge il riferimento, un numero ipertestuale, e torna su. In un elenco ci sono i nomi di dominio di ogni collegamento esterno e delle foto. Inoltre, il mio codice prima del collegamento aggiunge un'icona, 16x16, se il suo dominio è presente in una libreria di un file **json**, o altrimenti un simbolo standard.   
