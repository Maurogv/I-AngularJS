...
Poichè volevo funzionalità aggiuntive, con **Javascript** ho costruito l'indice, le note, l'elenco dei nomi di dominio di ogni collegamento esterno, una lista è solo per le foto. Il mio testo cita le fonti, e il codice crea un numero progressivo ipertestuale che va a quella associata, e nelle note torna su.  
