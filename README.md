...
Poichè volevo funzionalità aggiuntive, con **Javascript** ho costruito l'indice, le note, l'elenco dei nomi di dominio di ogni collegamento esterno, una lista è solo per le foto. Il testo cita le fonti, quindi esso aggiunge il riferimento, un numero ipertestuale, e nelle note torna su. Inoltre, il mio codice prima del collegamento con il nome del dominio aggiunge un'icona, 16x16, se il suo dominio è presente in una libreria di un file **json**, o altrimenti un simbolo standard.   
