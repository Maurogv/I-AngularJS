...
Poichè volevo funzionalità aggiuntive, con **Javascript** ho costruito l'indice, le note, l'elenco dei nomi di dominio di ogni collegamento esterno, una lista è solo per le foto. Il testo cita le fonti, quindi esso aggiunge il coleggamento ad esse, un numero ipertestuale, e nelle note torna su.  
